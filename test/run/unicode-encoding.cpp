...
int main() {
    ...
    assert((f5::u8encode(0xa2) == u8encoded{2, {{static_cast<char>(0xc2), static_cast<char>(0xa2), 0, 0}}}));
    assert((f5::u8encode(0x20ac)
            == u8encoded{3, {{static_cast<char>(0xe2), static_cast<char>(0x82), static_cast<char>(0xac), 0}}})); // euro
    assert((f5::u8encode(0x10348) == u8encoded{4, {{static_cast<char>(0xf0), static_cast<char>(0x90), static_cast<char>(0x8d), static_cast<char>(0x88)}}}));
